...
const getMyAuctions = async (req, res) => {
  try {
    const {id:userId} = req.user;
    const { page, limit, minPrice, maxPrice, sortBy, categoryId,status } = req.query;
...
module.exports = { createAuction, updateAuction, getActiveAuctions, getAuctionDetailById,getMyAuctions };
